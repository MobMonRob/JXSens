...
public class XsVectorClass {
  ...
  public SWIGTYPE_p_XsReal getM_data() {
    long cPtr = minimalJNI.XsVectorClass_m_data_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_XsReal(cPtr, false);
  }

  public SWIGTYPE_p_XsSize getM_size() {
    return new SWIGTYPE_p_XsSize(minimalJNI.XsVectorClass_m_size_get(swigCPtr, this), true);
  }

  public SWIGTYPE_p_XsSize getM_flags() {
    return new SWIGTYPE_p_XsSize(minimalJNI.XsVectorClass_m_flags_get(swigCPtr, this), true);
  }

  public SWIGTYPE_p_XsSize flags() {
    return new SWIGTYPE_p_XsSize(minimalJNI.XsVectorClass_flags(swigCPtr, this), true);
  }
